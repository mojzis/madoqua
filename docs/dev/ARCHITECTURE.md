...
| `guide.rs` | The agent-facing instructions: which topic, and detecting whether madoqua is wired into a directory. The prose is `include_str!`d from `docs/src/guide/`, never written here. | reads three files, tolerantly |
